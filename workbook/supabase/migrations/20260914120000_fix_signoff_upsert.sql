...
begin
  ...
  insert into public.action_signoffs(action_id, signed_off_by_name, signed_off_at)
  values (action_uuid, signer_name, now())
  on conflict (action_id) do update
  set signed_off_by_name = excluded.signed_off_by_name,
      signed_off_at = now();
end;
$$;
